...
<table width="98%" border="0" align="center" cellpadding="5">
	<tr style="border-bottom:#0099CC 1px solid;">
		<td align="left"><strong><font color="#000000" size="+1" face="黑体，宋体, Times New Roman, Arial">	项目管理</font></strong></td>
	...
	<tr>
		<td align="left" bgcolor="#EAEAEA" width="100%" colspan="2">
			...
			<p><input  name="id" value="<?php echo $id ?>" type="hidden"  /><br />
			 1、数据下载   <label> <input type="radio" name="xiazai" <?php if($xiazai==1){echo "checked='checked'";}?> value="1" />可以下载</label>
                            <label><input name="xiazai" type="radio" value="0" <?php if($xiazai==0){echo "checked='checked'";}?>/>不能下载</label>
			</p>
			<p>
				<label></label>
				<textarea name="downloads" cols="50" rows="4" ><?php echo $downloads ?></textarea>
			</p>
			<p>2、 项目完成时间 <input  name="date_f" value="<?php echo $date_f ?>" type="text" size="20"/>
				 时间 格式：  2008-08-24 <br /> <br /><br />
