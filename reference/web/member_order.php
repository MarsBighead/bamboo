...
// $_SESSION['username']='011';
?>
<table width="98%" border="0" align="center" cellpadding="5">
    <tr  style="border-bottom:#0099CC 1px solid;">
		<td align="left"> <font color="#000000" face="黑体，宋体, Times New Roman, Arial" size="+1" ><strong>我的正在进行项目</strong></font></td>
    ...
    <tr>
		...
		<table   width="100%"border="1" cellpadding='1' face="黑体，宋体, Times New Roman, Arial" style="font-size:15px;" >
			...
			<?php
				...
				$query=sprintf("select * from project where status<='1' and username = '%s' order by date desc", $_SESSION['username']);
				// echo "$query";
