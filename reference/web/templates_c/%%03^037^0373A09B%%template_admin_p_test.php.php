<?php /* Smarty version 2.6.16, created on 2014-03-10 16:32:37
         compiled from template_admin_p_test.php */ ?>
            ...
            <dl id="left_top_dl">
                ...
                <dl>
                        ...
                        <dd style="display: none;">
							...
							<li><a><form action="project_search.php" method="get" name="SearchForm"  id="SearchForm" style="margin:auto">
<input type="text" name="searchitem" size="10" style="width:100px;height:20px" />
<input type="submit" name="Submit" value="搜索" /></form></a></li>
