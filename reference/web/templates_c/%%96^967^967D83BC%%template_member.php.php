<?php /* Smarty version 2.6.16, created on 2014-08-15 11:21:45
         compiled from template_member.php */ ?>
            ...
            <dl id="left_top_dl">
                ...
                <dl>               
                    ...
                    <dd><!-- style="display: none;" -->
                        <ul>
                            <li><a href="member_order.php"  >正在进行项目</a> </li>
							<li><a href="member_order_over.php">已完成项目</a> </li>
							<li><a href="member_order_paid.php">已结清项目</a>  </li>
