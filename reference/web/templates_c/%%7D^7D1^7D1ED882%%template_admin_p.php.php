<?php /* Smarty version 2.6.16, created on 2014-08-18 09:40:16
         compiled from template_admin_p.php */ ?>
...
<body id="technology1">
<!-- head-->
<?php include("templates/head_suzhou.php") ?>
<!-- head-->
<div id="container">
<div id="main">
<!-- left-->
...
<!-- left-->
    <div id="rightsiderbar">
		<div id="nei"><?php echo $this->_tpl_vars['maincontent']; ?>
</div>     
    </div>
</div>
</div>
