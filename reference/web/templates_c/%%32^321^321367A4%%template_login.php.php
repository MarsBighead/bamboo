<?php /* Smarty version 2.6.16, created on 2014-08-15 17:51:04
         compiled from template_login.php */ ?>
...
<script src="js/style/stuHover.js" type="text/javascript"></script>
	...
	<div id="leftsiderbar">
        <div id="project_left">
            ...
            <dl id="left_top_dl">
                <dd>
					<dl>                    
						<dt id='part1' onclick="cookieset('part1');"><span>我的管理中心</span></dt>
        ...
        <div id="project_left">
            ...
            <dl id="left_top_dl">
                ...
                <dl>               
                    ...
                    <dd><!-- style="display: none;" -->
                        <ul>
							<li><a href="member_info.php">个人资料</a></li>                     
                            <li><a href="member_passwd.php">密码修改</a></li> 	
                            <li><a href="http://mail.geneskies.com" target="_blank">邮箱登录</a></li>                        
                            <li><a href="http://192.168.0.10:8080" target="_blank">生物信息软件   <sup style="font-size:8px;">上海版</sup></a></li>
							<li><a href="http://192.168.1.10:8000" target="_blank">生物信息软件   <sup style="font-size:8px;">苏州版</sup></a></li>                        
