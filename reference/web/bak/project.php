...
<table width="98%" border="0" align="center" cellpadding="5">
	...
	<tr>
		...
		<table width="100%" border="1" cellpadding='1' face="黑体，宋体, Times New Roman, Arial" style="font-size:15px;">
			<tr>
                <td width="14%" height="30" align="center"  ><a href="<?php echo "./project.php?paixu=number&line=$line";?>"><strong>项目编号</strong></a></td>
                <td width="32%" align="center" ><a href="<?php echo "./project.php?paixu=name&line=$line";?>"><strong>项目名称</strong></a></td>
		        <td width="14%" align="center" ><a href="<?php echo "./project.php?paixu=date&line=$line";?>"><strong>开始日期</strong></a></td>
				<td width="22%" align="center" ><a href="<?php echo "./project.php?paixu=date_end&line=$line";?>"><strong>截止日期</strong></a></td>
				<td width="18%" align="center" >项目管理</td>
            </tr>
			<?php
			...
			<tr>
				...
				<td align="center">
				<?php echo "<a href='project_jinzhan.php?id=$number' target='_blank' class='bluelink'>进展</a>   ";   ?>
				<?php
				...
				?>
				<?php 
				if($status==0){ echo "  <span style='color:#C0CCCC'>未启动</span>";}
				else{
					if($role==6 || ($role==4 )  ) {echo "<a href='project_anpai.php?type=$leibie&id=$number' target='_blank' class='bluelink' >安排</a>";} 
					else{echo "<a href='project_anpai_c.php?id=$number' target='_blank' class='bluelink' >已安排</a>";}
				}
				?>
				</td>
            </tr>
