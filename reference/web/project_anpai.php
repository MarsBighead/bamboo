...
if (!empty($_POST['submit'])){
	...
	for($i=0;$i<$count;$i++)
	{
		...
		{
			if($work_name==2){
			$names = array("2011002","2011024");
			}
			elseif($work_name==3){
			$names = array("2011004","2011022");
			}
			elseif($work_name==4){
			$names = array("2011016");
			}
			elseif($work_name==5){
			$names = array("2011012","2011023");
			} 
			elseif($work_name==6){
			$names = array("2011019");
			} 
...
　　<option value="3">胡军瑜组</option>
	...
	<option value="8">陈小燕组</option>
	<option value="9">张莹组</option>
	<option value="10">逯昌华组</option>
	<option value="11">李才华组</option>
	<option value="12">王磊组</option>
	<option value="13">高扬组</option>
	<option value="14">姜丽丽组</option>
	<option value="15">刘波组</option>
